        ...
        function r(e, r) {
          for (var a = {}, i = [], c = 0; c < e.length; c++) {
            ...
            if (-1 !== p) t[p].references++, t[p].updater(f);
              ...
              var b = o(f, r);
              (r.byIndex = c),
                t.splice(c, 0, { identifier: d, updater: b, references: 1 });
            }
            i.push(d);
          }
          return i;
    ...
    (() => {
      ...
      function v(e, t, n, r) {
        ...
        try {
          ...
          throw new Error(
            "Unable to create HTMLElement! Provide a proper tag name.",
          );
        }
        t &&
          (o = i.classList).add.apply(
            o,
            (function (e) {
          ...
          n && Array.isArray(n)
            ...
            : n && "object" === h(n)
              ? i.appendChild(n)
              : n && "string" == typeof n && (i.innerHTML = n),
          r && r.appendChild(i);
        for (
          var c = arguments.length, u = new Array(c > 4 ? c - 4 : 0), l = 4;
          l < c;
          l++
        )
          u[l - 4] = arguments[l];
          ...
          u.length &&
            u.forEach(function (e) {
              var t = (function (e, t) {
                ...
                n = t[0],
                r = t[1];
              "" === r ? i.setAttribute(n, "") : (i.dataset[n] = r);
            }),
          i
        );
      }
      ...
      function S(e) {
        var t = document.querySelector(".previous-operand"),
          n = document.querySelector(".current-operand");
        (t.textContent = e.previousOperand), (n.textContent = e.currentOperand);
      }
            ...
            (n = [
              {
                key: "enterNumber",
                value: function (e) {
                  "0" === this.displayValue || null === this.currentOperand
                    ? ((this.displayValue = e), (this.currentOperand = e))
                    : ((this.displayValue += e), (this.currentOperand += e));
                },
              },
              {
                ...
                value: function (e) {
                  "0" === this.currentOperand
                    ? this.previousOperand &&
                      ((this.operation = e),
                      (this.previousOperand =
                        this.previousOperand.toString().slice(0, -1) +
                        this.operation))
                    : (null !== this.previousOperand && this.compute(),
                      (this.operation = e),
                      (this.previousOperand =
              ...
              },
              {
                ...
                value: function () {
                  var e,
                    t = parseFloat(this.previousOperand),
                    n = parseFloat(this.currentOperand);
                  switch (this.operation) {
                    ...
                    case "/":
                      if (0 === n)
                        return this.clear(), void (this.displayValue = "Error");
                      e = t / n;
                      break;
                    default:
                      return;
                  }
                  (this.currentOperand = e.toString()),
                    (this.displayValue = this.currentOperand),
                    (this.operation = null),
                    (this.previousOperand = "");
                },
      ...
      (w = v("div", "calculator-grid", null, document.body)),
        (k = v("div", "output", null, w)),
        v("div", "previous-operand", null, k, ["data-previous-operand", ""]),
        v("div", "current-operand", "0", k, ["data-current-operand", ""]),
        [
          ...
          var t = e.text,
            n = e.data,
            r = e.class;
          v("button", void 0 === r ? "" : r, t, w, n);
        }),
        document.addEventListener("DOMContentLoaded", function () {
          !(function (e, t) {
            document
              .querySelectorAll('[data-role="number"]')
              .forEach(function (n) {
                n.addEventListener("click", function () {
                  e.enterNumber(n.textContent), t(e);
                });
              }),
              document
                .querySelectorAll('[data-role="operation"]')
                .forEach(function (n) {
                  n.addEventListener("click", function () {
                    e.chooseOperation(n.textContent), t(e);
                  });
                }),
              document
              ...
              document
                .querySelector('[data-role="equals"]')
                .addEventListener("click", function () {
                  e.compute(), t(e);
                }),
              document
              ...
              document
                .querySelector('[data-role="decimal"]')
                .addEventListener("click", function () {
                  e.decimal(), t(e);
                }),
              document
                .querySelector('[data-role="sign-change"]')
                .addEventListener("click", function () {
                  e.changeSign(), t(e);
                });
          })(E, S);
